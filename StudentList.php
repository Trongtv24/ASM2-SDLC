...
body {
    ...
    background-color: #483D8D; /* Deep blue background for the body */
...
button {
    ...
    border-radius: 7px; /* Bo tròn viền nút */
...
<body>
    ...
    <div class="tb1">   
    <div class="nut"><button><a class="aaa" href="login.php">Log out</a></button></div>
    <div class="bang">
